...
export async function POST(req:Request){
  ...
  await query('INSERT INTO services(title,description,content,slug,cover_image,icon,sort_order,visible) VALUES(?,?,?,?,?,?,?,?)',[b.title,b.description||'',b.content||'',slug,b.cover_image||'',b.icon||'Code2',Number(b.sort_order||0),b.visible===false?0:1]);
